...
def email_scenario(request, scenario_id):
    """
    Email a scenario report to the logged-in user.
    """
...
This report was generated by Retirement Planner.
        ...
        return HttpResponse('<div class="text-green-600">✓ Scenario report email sent successfully!</div>')

    except Exception as e:
        return HttpResponse(f'<div class="text-red-600">Error sending email: {str(e)}</div>')
